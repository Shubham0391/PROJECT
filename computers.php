  ...
  ?>
        <nav class="navbar navbar-default navbar-fixed-top">
          ...
          <div class="product_section">
            <h2> Computer</h2>
            <?php
            $query="select * from products where product_cat='computer' order by rand() limit 9";
            ...
            <div class="single_product text-center">
              ...
              <h4>Product price:$<?php echo $row['product_price']; ?></h4>
               <h4>
               <button> <a href="computers.php?product_id=<?php echo $row['product_id']; ?>">Add to cart</a></button>
              </h4>
            </div>
          <?php } ?>
            </div>
