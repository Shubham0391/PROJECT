  ...
  ?>
        <nav class="navbar navbar-default navbar-fixed-top">
          ...
          <div class="product_section">
            <h2> Mobiles</h2>
            <?php
            $query="select * from products where product_cat='mobile' order by rand() limit 12";
            ...
            <div class="single_product text-center">
              ...
              <h4>
               <button> <a href="mobile.php?product_id=<?php echo $row['product_id']; ?>">Add to cart</a></button>
              </h4>
            </div>
          <?php } ?>
            </div>
