                ...
                <form   action="" class="form-horizontal" method="POST" enctype="multipart/form-data">
                  ...
                  <button type="submit" name="submit" class="btn blue"><i class="icon-ok"></i> Save</button>
                            <a href="products.php" class="btn">Cancel</a>
                                    ...
                                    $prod_id=uniqid();
  $query="insert into products(product_cat,product_id,product_name,product_desc,"
                      . "product_img,product_price) values('$pro_cat','$prod_id','$pro_name','$pro_desc','$pro_img','$pro_price')";
